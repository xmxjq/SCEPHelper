 ...
 */
public class OldMainView {
    private static boolean isServerStarted = false;
    private static BackendServer backendServer = null;
    private static OldMainView mainView = null;
    ...
    public static OldMainView getInstance() {
        // 用这种方法可以防止窗口关闭进程结束，可以用来作为后台运行
        if (mainView==null){
            mainView = new OldMainView();
        }
        return mainView;
    }
    ...
    public static void main(String args[]) {
        OldMainView mainView = getInstance();
        mainView.show();
    }
}
